...
export default function BorderlessTourismSection() {
  ...
  return (
    <div
      ref={wrapperRef}
      className={`relative h-auto lg:h-[350vh]`}
    >
      <section
        ref={sectionRef}
        id="borderless-tourism"
        data-section="borderless-tourism"
        className="relative lg:sticky lg:top-0 lg:left-0 lg:right-0 lg:min-h-screen flex flex-col justify-start lg:justify-center bg-[#F8F8F8] py-14 lg:py-24 overflow-hidden"
      >
        <div className="w-full max-w-[1440px] mx-auto px-5 lg:px-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-start">
            ...
            <div className={`${poppins.className} order-2 lg:order-none pt-4 lg:pt-0`}>
              <h2
                ref={headingRef}
