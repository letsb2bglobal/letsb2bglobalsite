...
/**
 * Filled SVG icons for the Features section.
 * To use icons from SVGrepo (https://www.svgrepo.com):
 * 1. Download the SVG (e.g. "Download SVG" or copy the path).
...
export function IconHandshake(props: React.SVGProps<SVGSVGElement>) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      viewBox="0 0 24 24"
      ...
      {...props}
    >
      <path d="M11.562 2.05a1 1 0 01.876 0l8 4a1 1 0 010 1.8L19 8.95V18a2 2 0 01-2 2H7a2 2 0 01-2-2V8.95l-1.438-.1a1 1 0 010-1.8l8-4zM5 10.61l2.57 1.72a2 2 0 002.86-.72l1.14-1.71 2.86 1.92a2 2 0 002.64-.26l2.86-2.86V18H5V10.61z" />
    </svg>
  );
}
