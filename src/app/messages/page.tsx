                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex justify-between items-baseline">
                          <h4 className={`text-sm font-bold truncate ${isActive ? 'text-blue-600' : 'text-gray-900'}`}>
                            {(other?.company_name || `User ${conv.userAId === user?.id ? conv.userBId : conv.userAId}`).toUpperCase()}
                          </h4>
                        </div>
            ...
            {activeConv ? (
              <>
                ...
                <div className="p-4 border-b border-gray-100 flex items-center gap-3 bg-white z-10">
                   ...
                   <div>
                      <h3 className="font-bold text-gray-900 text-sm">{(otherUserProfile?.company_name || 'Business Partner').toUpperCase()}</h3>
                ...
                <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-[#f8f9fb]">
                  {messagesLoading ? (
                    ...
                    <div className="flex flex-col items-center justify-center h-full text-center p-8">
                       ...
                       <p className="text-gray-400 text-sm italic">Start the conversation with {(otherUserProfile?.company_name || 'this business partner').toUpperCase()}</p>
                    </div>
                  )}
