...
const mockEnquiries = [
  {
    id: 1,
    title: "Private Vehicle with Driver – Kochi Trip",
    company: "Le Meridian",
    timeAgo: "24 mins ago",
    location: "Kochi, Kerala, India",
    description:
      "Looking for a clean, well-maintained private vehicle with an experienced local driver for a family trip in and around Kochi.",
    tags: [
      "Kochi Travel",
      "Transportation",
      "Airport Pickup",
          ...
          <div className="col-span-12 lg:col-span-9 space-y-6">
                ...
                <div className="flex flex-col md:flex-row md:items-center gap-3">
                  <div className="flex-1">
                    <input
                      ...
                      placeholder="Search..."
                      className="w-[600px] h-9 sm:h-10 rounded-xl border border-slate-200 bg-white px-3 text-[13px] font-semibold placeholder:text-slate-400 text-slate-700 focus:outline-none focus:ring-2 focus:ring-[#6B3FA0]/20 focus:border-[#6B3FA0]"
                    />
                  </div>
            ...
            {activeTab === "business" && (
              <div className="bg-white rounded-xl border border-gray-100 shadow-sm mt-4">
                ...
                <div className="p-0">
                  {(showAllBusinesses ? mockBusinesses : mockBusinesses.slice(0, 3)).map(
                    (biz) => (
                      <div
                        key={biz.id}
                      ...
                      >
                        ...
                        <div className="flex flex-wrap gap-1.5">
                          {item.tags.map((tag) => (
                            <span
                              key={tag}
                              className="px-2 py-0.5 rounded-full bg-slate-50 text-[10px] sm:text-[11px] font-semibold text-slate-500"
                            >
                              {tag}
                            </span>
                          ))}
