...
const sections = [
  ...
  { id: 3, icon: BadgeCheck, title: "Membership & Access", bullets: ["Access levels and features depend on the membership type and plan selected.", "Paid memberships are subject to the pricing terms agreed at the time of subscription.", "LetsB2B reserves the right to modify, suspend, or terminate memberships for violations.", "Membership benefits are non-transferable and apply only to the registered entity."] },
  { id: 4, icon: ShieldCheck, title: "Verification", bullets: ["Verification is mandatory for full platform access.", "LetsB2B may request business documents or professional credentials at any time.", "Verification status may be revoked if information is found to be inaccurate or misleading.", "Verification does not guarantee specific business outcomes or results."] },
  ...
  { id: 8, icon: Scale, title: "Limitation of Liability", content: `LetsB2B acts solely as a facilitator and is not a party to any business transaction between members. We do not guarantee the accuracy of member profiles, the completion of any trade deal, or the quality of services offered by members. Users bear full responsibility for their own business decisions and due diligence.` },
  { id: 9, icon: FileText, title: "Intellectual Property", content: `All content, trademarks, logos, and platform materials are the property of LetsB2B. Users may not copy, reproduce, distribute, or create derivative works without express written permission. User-generated content remains the property of the respective user, but by posting, users grant LetsB2B a non-exclusive license to display it on the platform.` },
  { id: 10, icon: AlertCircle, title: "Termination", content: `LetsB2B reserves the right to suspend or terminate access to the platform at any time for violations of these Terms, without prior notice. Upon termination, all licenses granted under these Terms will immediately cease.` },
    ...
    >
      <div className="bg-[#6B3FA0]/10 border border-[#6B3FA0]/20 rounded-2xl p-5 flex items-start gap-4 mb-10">
        ...
        <p className="text-sm text-gray-700 leading-relaxed md:text-base">
          By accessing or using the LetsB2B platform, you agree to be bound by these Terms &; Conditions. If you do not agree, you must not access or use the platform. This platform is intended for <strong>tourism and hospitality B2B use only</strong>.
        </p>
      </div>
