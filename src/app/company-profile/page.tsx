          ...
          <div className="flex items-center justify-center relative mb-8">
            <div className="flex items-center justify-between w-full relative z-10 max-w-[200px]">
              ...
              <div className="flex flex-col items-center relative z-10">
                ...
                <span className="text-xs mt-2 text-gray-800 font-medium">Company info.</span>
              </div>

              <div className="flex flex-col items-center relative z-10">
                <div className="w-8 h-8 rounded-full border-2 border-gray-400 bg-white" />
                <span className="text-xs mt-2 text-gray-400">KYC Verification</span>
              </div>
            </div>
          </div>

          {/* Form */}
          <form onSubmit={handleSubmit} className="space-y-4 bg-white p-6 rounded-lg border border-slate-200 shadow-sm transition-all">
            {error && (
            ...
            <div className="flex justify-end">
              <div className="text-sm flex items-center gap-2 text-gray-600 cursor-pointer hover:text-black transition-colors font-medium">
                <div className="w-5 h-5 bg-black rounded-full flex items-center justify-center text-white text-xs font-bold">+</div> Add Social Media Profile
              </div>
            </div>
