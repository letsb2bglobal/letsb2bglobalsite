              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-start transition-all duration-300">
                ...
                <div className="mt-6 md:mt-0 flex flex-wrap gap-3">
                  ...
                  <button
                    ...
                    className="px-6 py-2 bg-green-600 text-white font-bold rounded-full hover:bg-green-700 transition-all shadow-xl shadow-green-100 flex items-center gap-2"
                  >
