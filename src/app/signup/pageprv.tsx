      ...
      {step === 'form' && (
        <form onSubmit={handleRegister} className="w-full space-y-4">
          ...
          <div className="space-y-1">
            ...
            {formData.password && (
              <div className="flex flex-wrap gap-x-3 gap-y-1 mt-2 ml-1">
                {[
        ...
        <form onSubmit={handleVerify} className="w-full space-y-5">
          ...
          <div className="space-y-1">
            <input
              ...
              maxLength={6}
              autoFocus
              className={`w-full px-4 py-3 sm:py-4 border rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500 text-center text-2xl sm:text-3xl font-black tracking-[0.2em] sm:tracking-[0.5em] text-gray-800 bg-white transition-all ${
